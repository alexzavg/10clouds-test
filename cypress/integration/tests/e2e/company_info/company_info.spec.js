...
describe('Company Info', function() {
    ...
    it('Update company info', function() {
        ...
        cy.get(companyInfoPageElements.taxNumberField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.taxNumberField).type(taxNumber).should('have.value', taxNumber)

        cy.get(companyInfoPageElements.firstNameField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.firstNameField).type(firstName).should('have.value', firstName)

        cy.get(companyInfoPageElements.lastNameField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.lastNameField).type(lastName).should('have.value', lastName)

        cy.xpath(companyInfoPageElements.adminMailField).scrollIntoView().clear().should('have.value', '')
        cy.xpath(companyInfoPageElements.adminMailField).type(adminEmail).should('have.value', adminEmail)

        cy.get(companyInfoPageElements.paymentFPEmailField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.paymentFPEmailField).type(adminEmail).should('have.value', adminEmail)

        cy.get(companyInfoPageElements.providerEmailField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.providerEmailField).type(adminEmail).should('have.value', adminEmail)

        cy.get(companyInfoPageElements.currencyField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.currencyField).type(currency).should('have.value', currency)
        ...
        cy.get(companyInfoPageElements.providerFirstNameField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.providerFirstNameField).type(firstName).should('have.value', firstName)

        cy.get(companyInfoPageElements.providerLastNameField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.providerLastNameField).type(lastName).should('have.value', lastName)

        cy.xpath(companyInfoPageElements.emailField).scrollIntoView().clear().should('have.value', '')
        cy.xpath(companyInfoPageElements.emailField).type(adminEmail).should('have.value', adminEmail)

        cy.get(companyInfoPageElements.addressField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.addressField).type(adminEmail).should('have.value', adminEmail)

        cy.get(companyInfoPageElements.countryField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.countryField).type(country).should('have.value', country)
        ...
        cy.get(companyInfoPageElements.stateField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.stateField).type(state).should('have.value', state)
        ...
        cy.get(companyInfoPageElements.cityField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.cityField).type(city).should('have.value', city)

        cy.get(companyInfoPageElements.zipField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.zipField).type(zip).should('have.value', zip)

        cy.get(companyInfoPageElements.phoneNumberField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.phoneNumberField).type(phoneNumber).should('have.value', phoneNumber)

        cy.get(companyInfoPageElements.companyWebAddressField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.companyWebAddressField).type(companyWebAddress).should('have.value', companyWebAddress)

        cy.get(companyInfoPageElements.numberOfUsersField).scrollIntoView().clear().should('have.value', '')
        cy.get(companyInfoPageElements.numberOfUsersField).type(numberOfUsers).should('have.value', numberOfUsers)
        ...
        cy.reload()
        // * disabled, API returns old values for some reason
